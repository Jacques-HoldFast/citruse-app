            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Create a new distributor record for citrus fruit distribution
                    </p>
                </div>
                <div>
...
const handleSubmit = async (formData) => {
    ...
    try {
        await api.createDistributor(formData)
        
        successMessage.value = 'Distributor created successfully!'
        
        // Redirect to distributors list after a short delay
        setTimeout(() => {
        ...
        if (error.response?.status === 422) {
            ...
            // General error
            errorMessage.value = error.response?.data?.message || 'Failed to create distributor. Please try again.'
        }
    } finally {
