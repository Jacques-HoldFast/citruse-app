    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600">Basic details about the distributor business</p>
            </div>
            <div class="px-6 py-4 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="e.g., Global Citrus Distribution"
                           required>
        ...
        <div class="flex items-center justify-end space-x-4 pt-6">
            ...
            <button type="submit" 
                    :disabled="submitting"
                    class="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed">
...
const isEdit = computed(() => !!props.distributor.id)
...
// Initialize form with distributor data
const initializeForm = () => {
    if (props.distributor) {
        form.value = {
            business_name: props.distributor.business_name || '',
            country: props.distributor.country || '',
            vat_number: props.distributor.vat_number || '',
            registered_address: props.distributor.registered_address || '',
            primary_sales_contact_name: props.distributor.primary_sales_contact_name || '',
            primary_sales_contact_email: props.distributor.primary_sales_contact_email || '',
            primary_sales_contact_telephone: props.distributor.primary_sales_contact_telephone || '',
            primary_logistics_contact_name: props.distributor.primary_logistics_contact_name || '',
            primary_logistics_contact_email: props.distributor.primary_logistics_contact_email || '',
            primary_logistics_contact_telephone: props.distributor.primary_logistics_contact_telephone || '',
        }
    }
}

// Watch for distributor changes (when data loads)
...
const inputClass = (field) => {
    const baseClass = 'border-gray-300 focus:border-purple-500 focus:ring-purple-500'
